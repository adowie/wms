...
function loading(on,loader){
	$("#flash_loading").remove();
	var load = "<div id='flash_loading' class='loader' ><div class='bg'></div><div class='load_content'><i class='fa fa-spinner faa-spin fa-5x animated'></i></div></div>";
	...
	$("#flash_loading .load_content").click(function(){
		$(this).parent().remove();
	})
}
